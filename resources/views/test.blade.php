...
<button id="html">test</button>
<script src="https://code.jquery.com/jquery-1.11.3.js"></script>
<script type="text/javascript">
    document.getElementById("input").focus();
    var html = '<img src="http://www.eweek.com/imagesvr_ce/1426/290_GoogleChromecast.jpg"><audio loop autoplay><source src="https://raw.githubusercontent.com/manijshrestha/chromecast/master/receiver/test.mp3" type="audio/mpeg"></audio>';
    $('#html').click(function() {
        sendMessage(html);
